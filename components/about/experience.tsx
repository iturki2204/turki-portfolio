...
const ENTRIES: Entry[] = [
  {
    company: "CFO Simulator",
    role: "محاكي تدريب على منصب المدير المالي",
    period: "سبتمبر 2026 – الآن",
    brand: "#0f6b4f",
  },
  {
    company: "FINAI",
    role: "منصة ذكاء مالي عربية أولًا",
    period: "سبتمبر 2026 – الآن",
    brand: "#8a6d00",
  },
  {
    company: "T1",
    role: "نظام حياة شخصي، بيانات محلية بالكامل",
    period: "سبتمبر 2026",
    brand: "#332e7a",
  },
  {
    company: "مافيا",
    role: "لعبة مافيا عربية متعددة اللاعبين",
    period: "أغسطس 2026 – الآن",
    brand: "#7f1d2b",
  },
];
    ...
    <div className="flex flex-col gap-3">
      ...
      >
        ...
        {hiddenCount > 0 && (
          ...
          >
            {open ? "عرض أقل" : `عرض ${hiddenCount} أخرى`}
            <motion.span
